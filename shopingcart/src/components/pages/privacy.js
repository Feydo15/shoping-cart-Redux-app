...
agree to the terms and conditions of credit applications and other products and services that contain provisions dealing with the use or disclosure of your PI;
make general enquiries, lodge complaints, and communicate with us;
apply for vacancies on our Careers portal by submitting your CV and thereafter should you be employed as an associate of the Group;
...
We use trusted third-party services including Google Analytics that collect, monitor and analyse our users’ usage. To prevent your PI from being used by Google Analytics you can install an opt-out browser add-on (visit https://tools.google.com/dlpage/gaoptout for details).
...
Processing includes gathering your personal data, disclosing it as stipulated in clause 7 below, and combining it with other personal information. We collect and process your PI to: -
...
engage in our legitimate business, related interests, and legal purposes, including but not limited to detecting and preventing fraud and conducting our business as a fashion-value retailer.
...
We will only keep your PI for as long as necessary to fulfil the purposes set out in this Policy and in our PAIA manual (which can be found on our website www.mrpricegroup.com), unless:
retention of the PI is required or authorised by law; or
...
If you live or work in the EU and believe there has been an infringement of your data protection rights, you are entitled to submit a complaint to a data protection authority in the EU Member State where you live or work. The contact details of each EU Data Protection Authority can be found at the following website: http://ec.europa.eu/justice/data-protection/article-29/structure/data-protection-authorities/index_en.htm
